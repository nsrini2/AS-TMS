class GeneralObserver < ActiveRecord::Observer
  ...
  observe Abuse, Answer, BlogPost, Comment, Group, GroupInvitation, GroupMembership, GroupPost, Note, Profile, ProfileAward, Question, QuestionReferral, Reply, GetthereBooking

  @@monitor_after_create = Set.new([Abuse, Answer, BlogPost, Comment, GroupInvitation, GroupPost, Note, Profile, ProfileAward, Question, QuestionReferral, Reply, GetthereBooking])
  ...
  @@monitor_after_update = Set.new([Answer, Group, GroupMembership, GroupInvitation])
