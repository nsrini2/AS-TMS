module MarketingMessagesHelper
  ...
  def showcase_marketing_image_tag(message)
    link_to_if(message.link_to_url, image_tag( showcase_marketing_image_path(message), :alt => '', :width => "395", :height => "146"),message.link_to_url,:target => "_blank") if message
  end
 ...
 def link_to_create_booth_marketing_message(group)
  ...
  def booth_marketing_image_tag(message)
    link_to_if(message.link_to_url, image_tag( booth_marketing_image_path(message), :alt => '', :width => "320", :height => "118"),message.link_to_url,:target => "_blank") if message
  end
