...
ActiveRecord::Schema.define(:version => 20110308201506) do
  ...
  add_index "audit_values", ["attribute"], :name => "index_audit_values_on_attribute"
  ...
  add_index "blog_posts", ["profile_id"], :name => "index_blog_posts_on_profile_id"
